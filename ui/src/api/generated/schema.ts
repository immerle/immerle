...
export interface paths {
    ...
    "/admin/lastfm": {
        ...
        /** Get the Last.fm scrobbling feature state */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["immerle.LastFmAdminDTO"];
                    };
                };
            };
        };
        /**
         * Update Last.fm scrobbling settings
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": Record<string, never> | components["schemas"]["immerle.lastFmUpdateRequest"];
                };
            };
            responses: {
                /** @description OK */
    ...
    "/hall-of-fame/tracks": {
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": Record<string, never> | components["schemas"]["immerle.hallOfFameOrderRequest"];
                };
            };
            responses: {
                /** @description OK */
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": Record<string, never> | components["schemas"]["immerle.hallOfFameAddRequest"];
                };
            };
            responses: {
                /** @description No Content */
    ...
    "/hall-of-fame/tracks/{trackId}/note": {
        ...
        patch: {
            ...
            requestBody: {
                content: {
                    "application/json": Record<string, never> | components["schemas"]["immerle.hallOfFameNoteRequest"];
                };
            };
            responses: {
                /** @description No Content */
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["immerle.LastFmStatusDTO"];
                    };
                };
                /** @description Unauthorized */
                401: {
    ...
    "/me/lastfm/connect/finish": {
        ...
        post: {
            ...
            /** @description Approved auth token */
            requestBody: {
                content: {
                    "application/json": Record<string, never> | components["schemas"]["immerle.lastFmConnectFinishRequest"];
                };
            };
            responses: {
                /** @description OK */
    ...
    "/me/lastfm/connect/start": {
        ...
        put?: never;
        /**
         * Start connecting a Last.fm account
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["immerle.lastFmConnectStartResponse"];
                    };
                };
                /** @description Unauthorized */
                401: {
...
export interface components {
    schemas: {
        ...
        "immerle.LastFmAdminDTO": {
            /** @example false */
            configured?: boolean;
            /** @example false */
            enabled?: boolean;
        };
        "immerle.LastFmStatusDTO": {
            connected?: boolean;
            /** @example bob */
            username?: string;
        };
        ...
        "immerle.lastFmConnectFinishRequest": {
            token?: string;
        };
        "immerle.lastFmConnectStartResponse": {
            authUrl?: string;
            token?: string;
        };
        "immerle.lastFmUpdateRequest": {
            apiKey?: string;
            apiSecret?: string;
            enabled?: boolean;
        };
        ...
        "immerle.songView": {
            ...
            bpm?: number;
            /**
             * @description Comment is a personal nostalgia note on this track (e.g. "listened to
